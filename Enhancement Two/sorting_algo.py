...
# sorting_algo.py
#
# Visual representation of sorting algorithms, displaying the basic
# concepts of algorithm efficiency and big-O notation.
# 
# Erik Roccuzzo 7/21/2020
#
...
if __name__ == "__main__":
    ...
    # -------------------------------------------------
    # These will be replaced by values pulled from sensorsData.db
